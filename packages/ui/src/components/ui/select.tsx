...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "ui-flex ui-h-10 ui-w-full ui-items-center ui-justify-between ui-rounded-lg ui-border ui-border-slate-200 ui-bg-white ui-px-3 ui-py-2 ui-text-sm ui-text-black ui-ring-offset-white placeholder:ui-text-slate-500 focus:ui-outline-black focus:ui-ring-2 focus:ui-ring-slate-950 focus:ui-ring-offset-2 disabled:ui-cursor-not-allowed disabled:ui-opacity-50 [&>span]:ui-line-clamp-1 dark:ui-border-slate-800 dark:ui-bg-slate-950 dark:ui-ring-offset-slate-950 dark:placeholder:ui-text-slate-400 dark:focus:ui-ring-slate-300",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="ui-h-4 ui-w-4 ui-opacity-50 ui-text-black" />
