...
const navigationMenuTriggerStyle = cva(
  "ui-group ui-inline-flex ui-h-10 ui-w-max ui-items-center ui-justify-center ui-bg-transparent ui-mx-2 ui-my-2 ui-px-4 ui-py-2 ui-text-sm ui-font-medium ui-transition-all hover:ui-border-b-2 hover:ui-border-blue-900 hover:ui-text-blue-900 focus:ui-border-b-2 focus:ui-border-blue-900 focus:ui-text-blue-900 disabled:ui-pointer-events-none disabled:ui-opacity-50 data-[active]:ui-border-b-2 data-[state=open]:ui-border-b-2 dark:ui-text-slate-50"
)
